...
3. You can filter tickers in the screener by indices such as the S&P 500, S&P 500 Sectors, NASDAQ 100, Dow 30 or IPO (YEAR>=2020), providing valuable insights for more granular market observation.<br>
...
10. Pie chart is also helpful to visualize the parameter change over the time.<br>
11. This screener also features a 1 minute CandleStick Chart for last FIVE BUSINESS DAYS.<br>
