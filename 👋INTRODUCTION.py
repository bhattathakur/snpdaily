...
1. MARKET OVERVIW gives broad insight of the market (like gainers, losers, etc) for different indices or sector sectors in tabs.<br>
...
5. The SMA-N-MISC indicator helps assess the position of the last price relative to key Simple Moving Averages (SMA) — 21, 50, and 200 periods — which can indicate potential mean reversion opportunities. <br>
...
10. The CHART feature generates a yearly chart for given ticker and provides ALL-TIME key information about the stock’s performance.
11. Pie chart is also helpful to visualize the parameter change over the time.<br>
12. This screener also features a 1 minute CandleStick Chart for last FIVE BUSINESS DAYS.<br>
