...
data=[go.Candlestick(x=df['Date'],open=df['Open'],high=df['High'],low=df['Low'],close=df['Close'],name=f'{ticker}-CLOSE {close:>11.2f}')]
...
sma21_data=go.Scatter(x=df['Date'],y=df['SMA_21'],mode='lines',name=f'SMA21 {sma21:>24.2f}',line=dict(color='violet',width=2))
