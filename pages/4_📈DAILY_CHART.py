...
data=[go.Candlestick(x=df['Date'],open=df['Open'],high=df['High'],low=df['Low'],close=df['Close'],name=f'{ticker}-CLOSE {close:>11}')]
...
sma10_data=go.Scatter(x=df['Date'],y=df['SMA_10'],mode='lines',name=f'SMA10 {sma10:>25.2f}',line=dict(color='green',width=2))
sma50_data=go.Scatter(x=df['Date'],y=df['SMA_50'],mode='lines',name=f'SMA50 {sma50:>25.2f}',line=dict(color='yellow',width=2))
sma200_data=go.Scatter(x=df['Date'],y=df['SMA_200'],mode='lines',name=f'SMA200 {sma200:>24.2f}',line=dict(color='red',width=2))
vwap_data=go.Scatter(x=df['Date'],y=df['VWAP'],mode='lines',name=f'VWAP [{vwap:>26.2f}]',line=dict(color='orange',width=2))
#container 1
